...
categories = ["Housing", "Transportation", "Groceries", "Food", "Utilities", "Insurance", "Medical", "Savings", "Personal", "Entertainment", "Miscellaneous", "Income", "Transfer", "Giftcard", "Fee", "Subscription", "Pet"]
